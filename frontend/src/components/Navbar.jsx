      ...
      <div className="w-full px-0 sm:px-1 md:px-2 lg:px-3">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex-shrink-0 ml-4 sm:ml-5 md:ml-6 lg:ml-8">
            <img 
              src="https://res.cloudinary.com/dvkxgrcbv/image/upload/v1766831916/1_osqlws.svg" 
              alt="sarisanskruti Logo" 
              className="h-15 sm:h-18 md:h-20 w-auto hover:scale-105 transition-transform duration-300"
            />
          </Link>
