  ...
  const socialLinks = [
    {
      ...
      url: 'https://facebook.com/sarisanskruti',
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://instagram.com/sarisanskruti',
    },
    {
      name: 'Pinterest',
      icon: (
      ...
      url: 'https://pinterest.com/sarisanskruti',
    },
    {
      name: 'YouTube',
      icon: (
      ...
      url: 'https://youtube.com/@sarisanskruti',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-4">
          ...
          <Link to="/" className="flex-shrink-0">
            <img 
              src="https://res.cloudinary.com/dvkxgrcbv/image/upload/v1766831916/2_dpnu0s.svg" 
              alt="sarisanskruti Logo" 
              className="h-16 sm:h-20 md:h-24 w-auto hover:scale-105 transition-transform duration-300 mb-3"
            />
          </Link>
