      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 p-8 bg-gradient-to-br from-amber-50 to-white border-2 border-amber-100 rounded-lg shadow-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              For privacy concerns, email us at <a href="mailto:support@sarisanskruti.in" className="text-amber-600 hover:text-amber-700 underline">support@sarisanskruti.in</a>.
            </p>
          </div>
