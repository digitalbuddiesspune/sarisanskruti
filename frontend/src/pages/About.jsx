      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="mb-20">
          <h2 className="text-3xl font-light tracking-wider mb-12 text-gray-900 text-center">
            WHAT MAKES sarisanskruti SPECIAL?
          </h2>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-light tracking-wider mb-8 text-gray-900">
            CELEBRATE EVERY MOMENT WITH sarisanskruti
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            Be it a Kanjivaram that shines at weddings, a soft linen saree for daytime charm, or a Banarasi that turns every occasion into a celebration — sarisanskruti brings you collections that make every woman feel special.
          </p>
          ...
          <p className="text-xl font-light text-amber-700 italic tracking-wide">
            Discover your story. Drape your tradition. Only at sarisanskruti.
          </p>
        </div>
