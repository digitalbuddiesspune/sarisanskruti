        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12 p-8 bg-gradient-to-br from-amber-50 to-white border-2 border-amber-100 rounded-lg shadow-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.sarisanskruti.in ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
          </div>
          ...
          <div className="mb-12 p-8 bg-gradient-to-br from-amber-50 to-white border-2 border-amber-100 rounded-lg shadow-md">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              The Platform is owned by <strong className="text-gray-900">SAVARIYAAN TECHNORAFT PRIVATE LIMITED</strong>, a company incorporated under the Companies Act, 1956 with its registered office at <strong className="text-gray-900">Office No 114,1st floor, Vardhman Capital Mall, Plot no 9 & 10, L.S.C  Shakti Nagar Gulabi Bagh, Delhi 110007</strong>.
            </p>
          </div>
